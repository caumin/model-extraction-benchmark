...
- SET-C1 (`xie2019`) substitute defaults: `batch=256`, `optimizer=sgd(lr=0.1,momentum=0.9,wd=5e-4)`, `scheduler=multistep([0.5,0.75],gamma=0.1)`, `max_epochs=90`, `patience=90`; selection remains best-by-validation-loss while runs stay fixed at 90 epochs.
