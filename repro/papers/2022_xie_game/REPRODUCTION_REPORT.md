...
## Preparation Update (2026-02-23)

- Added operations runbook and execution TODO:
  - `repro/papers/2022_xie_game/ULTRAWORK_RUNBOOK.md`
  - `repro/papers/2022_xie_game/TODO_ULTRAWORK.md`
- Added design documents for this ultrawork cycle:
  - `docs/design/UTILS_API_MINIMIZATION_PLAN.md`
  - `docs/design/GAME_REFACTOR_ULTRAWORK_PLAN.md`
- Applied non-GAME dead-code cleanup and deprecation policy so GAME refactor can proceed on a cleaner baseline.
