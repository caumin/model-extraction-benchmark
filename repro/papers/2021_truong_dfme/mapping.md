...
| Victim input scaling | keep victim input unchanged (official-like query/eval path) | `victim.input_scale_mode` | `unit` |
| Query input scaling | synthetic tanh outputs queried directly | `attack.query_input_scale_mode` | `tanh` |
