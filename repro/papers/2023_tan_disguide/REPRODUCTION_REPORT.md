...
- [x] victim wrapper preprocess profile fixed to `dfme_cifar10_test`
- [x] compare target extracted (`acc_gt` @ 20M = 0.9402)
- [ ] smoke run completed
- [ ] full run completed
...
```bash
python repro/run_experiment.py preflight --paper-id 2023_tan_disguide --profile full
```
