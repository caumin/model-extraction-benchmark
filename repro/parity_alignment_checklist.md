...
- [ ] Experimental parity gaps remain (`32x32` resize, half-* substitute architectures, runtime/data-pipeline differences).
- [x] Data-free query-scale contract fixed: oracle-boundary queries stay `[-1,1]` with no attacker-side tanh->unit conversion.
